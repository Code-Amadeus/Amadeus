...
funasr_models = {}  # Cache models to avoid repeated loads.
...
def create_model(language="zh"):
    path_vad  = 'assets/models/asr/speech_fsmn_vad_zh-cn-16k-common-pytorch'
    path_punc = 'assets/models/asr/punc_ct-transformer_zh-cn-common-vocab272727-pytorch'
    path_vad  = path_vad if os.path.exists(path_vad) else "iic/speech_fsmn_vad_zh-cn-16k-common-pytorch"
    path_punc = path_punc if os.path.exists(path_punc) else "iic/punc_ct-transformer_zh-cn-common-vocab272727-pytorch"
    vad_model_revision = punc_model_revision = "v2.0.4"

    if language == "zh":
        path_asr = 'assets/models/asr/speech_paraformer-large_asr_nat-zh-cn-16k-common-vocab8404-pytorch'
        path_asr = path_asr if os.path.exists(path_asr) else "iic/speech_paraformer-large_asr_nat-zh-cn-16k-common-vocab8404-pytorch"
        model_revision = "v2.0.4"
    elif language == "yue":
        path_asr = 'assets/models/asr/speech_UniASR_asr_2pass-cantonese-CHS-16k-common-vocab1468-tensorflow1-online'
        ...
        # Cantonese VAD can occasionally hit shape mismatch errors. Running
        # without VAD works, but punctuation must be handled separately and the
        # punctuation model is weak for Cantonese.
    else:
...
def execute_asr(input_folder, output_folder, model_size, language):
    ...
    with open(output_file_path, "w", encoding="utf-8") as f:
        f.write("\n".join(output))
        print(f"ASR task complete -> annotation file: {output_file_path}\n")
...
if __name__ == '__main__':
    ...
    parser.add_argument("-p", "--precision", type=str, default='float16', choices=['float16','float32'],
                        help="fp16 or fp32")  # Not wired yet.
