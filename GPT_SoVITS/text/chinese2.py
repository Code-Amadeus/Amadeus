...
if is_g2pw:
    ...
    g2pw = G2PWPinyin(model_dir="GPT_SoVITS/text/G2PWModel",model_source=os.environ.get("bert_path","assets/models/gpt-sovits/pretrained/chinese-roberta-wwm-ext-large"),v_to_u=False, neutral_tone_with_five=True)
