...
<p>
  ...
  <img src="https://img.shields.io/badge/source-available%20alpha-2f624a?labelColor=061710" alt="源码状态"/>
...
> [!IMPORTANT]
> 本仓库包含可构建、可运行的公开源码，但仍是面向开发者的
> **source-available alpha**，不是带安装器的正式桌面发行版。首方代码采用
