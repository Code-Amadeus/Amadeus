...
def _research_adapter() -> ProviderAdapter:
    from agent_host.adapters import ResearchAdapter
...
def builtin_provider_specs(
    *,
    ...
    return (
        ...
        BuiltinProviderSpec("research", _research_adapter, True),
        BuiltinProviderSpec("openclaw",_openclaw_adapter,bool(settings.OPENCLAW_TOKEN),),
        BuiltinProviderSpec(
            "codex",
