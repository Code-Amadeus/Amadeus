            ...
            {section === 'general' ? (
              <div className="flex flex-col gap-5">
                ...
                <SettingsGroup title="Multimodal & Vision">
                  ...
                  <ComboCard icon="Robot" title="Vision Provider" content="Direct image input requires an image-capable chat model, such as DeepSeek Flash, OpenAI, or Gemini" value={val('vision_provider', 'auto')} onChange={value => handleChange('vision_provider', value)} options={['auto', 'openai', 'gemini', 'deepseek', 'custom']} disabled={!bool('vision_enabled')} />
